...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/11/09 15:28:28 by qmoreaux          #+#    #+#             */
/*   Updated: 2016/12/14 20:34:13 by rfernand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ope.h"

int	get_value_or_1(t_env *env, int arg, unsigned char codage, int num_player)
{
	int value;
...
int	get_value_or_2(t_env *env, int arg, unsigned char codage, int num_player)
{
	int value;
...
int	op_or(t_env *env, int num_player, unsigned int op_args[3], \
	unsigned char codage)
{
	...
	codage, 1) && is_direct(op_args[1], codage, 1)))
		return (-1);
	value = get_value_or_1(env, op_args[0], codage, num_player);
	value2 = get_value_or_2(env, op_args[1], codage, num_player);
