...
/*   Updated: 2016/12/14 21:51:52 by qmoreaux         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ope.h"

void	op_lfork_copy(t_env *env, int num_player, int dest, int value)
{
	...
	position_2_bytes(env, value, num_player, 0);
...
int		op_lfork(t_env *env, int num_player, unsigned int op_args[3], \
	unsigned char codage)
{
	...
	op_lfork_copy(env, num_player, num_instance, op_args[0]);
	return (0);
	codage = 0;
}
